...
entry_points = \
{'console_scripts': ['chain_fusion_samples = '
                     'cupcake.tofu.counting.chain_fusion_samples:main',
                     'chain_samples = cupcake.tofu.counting.chain_samples:main',
                     'collapse_isoforms_by_sam = '
                     'cupcake.tofu.collapse_isoforms_by_sam:main',
                     'color_bed12_post_sqanti = '
                     'cupcake.tofu.color_bed12_post_sqanti:main',
                     'evaluate_alignment_sam = '
                     'cupcake.annotation.alignment_stats_from_sam:main',
                     'filter_away_subset = '
                     'cupcake.tofu.filter_away_subset:main',
                     'filter_by_count = cupcake.tofu.filter_by_count:main',
                     'fusion_collate_info = '
                     'cupcake.tofu.fusion_collate_info:main',
                     'fusion_finder = cupcake.tofu.fusion_finder:main',
                     'get_abundance_post_collapse = '
                     'cupcake.tofu.get_abundance_post_collapse:main',
                     'make_fake_genome = '
                     'cupcake.phasing.create_fake_genome:main',
                     'make_file_for_subsample = '
                     'cupcake.annotation.make_file_for_subsampling_from_collapsed:main',
                     'parse_matchAnnot = '
                     'cupcake.annotation.parse_matchAnnot:main',
                     'run_phaser = cupcake.phasing.run_phaser:main',
                     'scrub_sample_GFFs = '
                     'cupcake.tofu.counting.scrub_sample_GFF_junctions:main',
                     'simple_stats_post_collapse = '
                     'cupcake.tofu.simple_stats_post_collapse:main',
                     'subsample = cupcake.annotation.subsample:main',
                     'subsample_with_category = '
                     'cupcake.annotation.subsample_with_category:main',
                     'summarize_junctions = '
