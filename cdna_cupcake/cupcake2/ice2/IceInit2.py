...
from cdna_cupcake.cupcake2.ice2.AlignerRunners import run_minimap
from cdna_cupcake.cupcake2.ice2.IceUtils2 import minimap2_against_ref2
...
class IceInit2(object):
    ...
    def makeGraphFromMinimap2(self, align_filename, len_dict):
        ...
        logging.debug(
            "total {} edges added from {}; took {} sec".format(
    ...
    def init_cluster_by_clique(self):
        ...
        len_dict = {r.id: len(r.seq) for r in SeqIO.parse(open(self.readsFa), "fasta")}
