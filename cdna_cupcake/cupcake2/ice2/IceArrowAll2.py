...
from cdna_cupcake.cupcake2.ice2.IceArrow2 import IceArrow2
from cdna_cupcake.cupcake2.ice2.IceArrowPostProcess2 import IceArrowPostProcess2
...
class IceArrowAll2(object):
    ...
    def _cmd_str(
        self, root_dir, subread_xml, sge_opts, ipq_opts, report_fn, summary_fn, tmp_dir
    ):
    ...
    def run(self):
        ...
        icepq = IceArrowPostProcess2(
            root_dir=self.root_dir, quit_if_not_done=False, ipq_opts=self.ipq_opts
        )
        icepq.run()
        return 0
