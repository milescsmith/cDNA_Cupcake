...
if __name__ == "__main__":
    ...
    parser = ArgumentParser(
        "Run IceInit2: initial clique finding on full-length reads."
    )
    parser.add_argument("flnc_fa", help="FLNC fasta filename")
    parser.add_argument("output_pickle", help="Output pickle filename")
    parser.add_argument(
        "--ece_penalty", default=1, type=int, help="ECE penalty (default: 1)"
    )
    parser.add_argument(
        "--ece_min_len", default=20, type=int, help="ECE min len (default: 20)"
    )
    parser.add_argument(
        "--max_missed_start",
        default=100,
    ...
    parser.add_argument(
        "--max_missed_end", default=30, type=int, help="Max missed 3' (default: 30 bp)"
    )
    parser.add_argument(
        "--cpus", default=4, help="Number of CPUs aligner uses (default: 4)"
    )
