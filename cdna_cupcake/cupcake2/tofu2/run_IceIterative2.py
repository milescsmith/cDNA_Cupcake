...
from cdna_cupcake.cupcake2.tofu2.ClusterOptions2 import SgeOptions2, IceOptions2

from cdna_cupcake.cupcake2.ice2.IceIterative2 import IceIterative2
from cdna_cupcake.cupcake2.tofu2.run_IceInit2 import run_IceInit2
...
if __name__ == "__main__":
    ...
    parser = add_sge_arguments(
        parser, blasr_nproc=True, gcon_nproc=True, arrow_nproc=False
    )
