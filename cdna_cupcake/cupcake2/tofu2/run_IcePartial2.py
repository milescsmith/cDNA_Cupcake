...
from cdna_cupcake.cupcake2.tofu2.ClusterOptions2 import IceOptions2, SgeOptions2
...
from cdna_cupcake.cupcake2.ice2.IcePartialAll2 import (
    IceAllPartials2,
    add_ice_all_partials_arguments,
)

from cdna_cupcake.cupcake2.ice2.IcePartial2 import (
    IcePartialOne2,
    add_ice_partial_one_arguments,
)

from cdna_cupcake.cupcake2.ice2.IcePartialSplit2 import (
    IcePartialSplit2,
...
from pbtranscript.ice.IcePartialMerge import (
    IcePartialMerge,
...
class IcePartialRunner(PBMultiToolRunner):
    ...
    def __init__(self):
        ...
        parser = subparsers.add_parser("all", description=IceAllPartials2.desc)
        add_ice_all_partials_arguments(parser)

        parser = subparsers.add_parser("one", description=IcePartialOne2.desc)
        add_ice_partial_one_arguments(parser)

        parser = subparsers.add_parser("split", description=IcePartialSplit2.desc)
        ...
        #
        parser = subparsers.add_parser("merge", description=IcePartialMerge.desc)
        ...
        try:
            ...
            if cmd == "all":
                ...
                obj = IceAllPartials2(
                    ...
                    if args.fastq_filenames is not None
                    else None,
